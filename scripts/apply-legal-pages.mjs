...
const pages = [
  {
    ...
    body: `<section class="page-hero compact-hero"><div class="container narrow"><p class="eyebrow">Website Privacy Notice</p><h1>Website Privacy Notice</h1><p class="lead">This notice explains how Sequrin Technologies (Pty) Ltd handles information collected through sequrin.com and ordinary business communications.</p><p class="updated">Last updated 23 August 2026</p></div></section>
...
<article><p class="notice-index">03</p><div><h2>Future customer-controlled processing</h2><p>A future controlled claims evaluation requires a documented customer role, purpose, lawful basis, contract, impact assessment, security review, retention, recipients, transfer safeguards, rights route and prior-authorisation assessment where applicable.</p><p>Sequrin does not have standing approval to use identifiable or pseudonymised customer claims for general model training. Product decision boundaries are described in the <a class="text-link" href="../governance/">Governance principles</a>.</p></div></article>
...
<article><p class="notice-index">06</p><div><h2>Your rights</h2><p>Subject to POPIA, PAIA and third-party rights, you may ask about access, correction, deletion or objection by emailing <a class="text-link" href="mailto:info@sequrin.com">info@sequrin.com</a>. The <a class="text-link" href="../paia/">PAIA Manual</a> explains record requests. You may also use the Information Regulator's <a class="text-link" href="https://inforegulator.org.za/">official channels</a>.</p></div></article>
  ...
  },
  {
    ...
    body: `<section class="page-hero compact-hero"><div class="container narrow"><p class="eyebrow">PAIA Manual</p><h1>PAIA Manual for Sequrin Technologies (Pty) Ltd</h1><p class="lead">This manual is prepared under section 51 of the Promotion of Access to Information Act 2 of 2000, as amended, and includes relevant POPIA particulars.</p><p class="updated">Version 1.1 &middot; 23 August 2026</p></div></section>
...
<article><p class="notice-index">09</p><div><h2>Availability and updating</h2><p>The current public version of this Manual is available free of charge on this page and may also be requested from info@sequrin.com. It is available for public inspection at Sequrin's principal place of business during normal business hours by prior arrangement and will be supplied to the Information Regulator upon request as required by PAIA.</p><p>Sequrin reviews the Manual at least annually and when a material change affects contact details, records, processing activities, legal obligations or access procedures.</p></div></article>
  ...
  },
  {
    ...
    body: `<section class="page-hero compact-hero"><div class="container narrow"><p class="eyebrow">Website Terms</p><h1>Terms of Use for sequrin.com</h1><p class="lead">These terms govern sequrin.com, operated by Sequrin Technologies (Pty) Ltd, enterprise number 2026/662912/07.</p><p class="updated">Last updated 22 August 2026</p></div></section>
<section class="section"><div class="container notice-list">
<article><p class="notice-index">01</p><div><h2>Product information</h2><p>The site describes Sequrin's product capabilities, company and longer-term direction. Interface views may use demonstration data. Nothing on the site is medical, claims, forensic, legal or investment advice; a promise of savings or detection accuracy; an offer to provide a regulated service; or evidence of a customer deployment, regulatory approval or certification.</p></div></article>
<article><p class="notice-index">02</p><div><h2>Lawful use</h2><p>You may view the site and share links for ordinary informational use. Do not interfere with security, access restrictions or availability; reverse engineer protected software; imply endorsement; remove notices; or use protected content to train a competing model without written permission or a lawful exception.</p></div></article>
...
<article><p class="notice-index">05</p><div><h2>Privacy, law and contact</h2><p>The <a class="text-link" href="../privacy/">Privacy Notice</a> explains current information handling and the <a class="text-link" href="../paia/">PAIA Manual</a> explains record requests. South African law applies; courts with jurisdiction in Gauteng are non-exclusive. Send legal or intellectual-property notices to <a class="text-link" href="mailto:info@sequrin.com">info@sequrin.com</a>.</p></div></article>
  ...
  },
  {
    ...
    body: `<section class="page-hero compact-hero"><div class="container narrow"><p class="eyebrow">Cookie and Tracking Statement</p><h1>Cookie and Tracking Statement</h1><p class="lead">This statement describes the cookies, analytics and related tracking technologies used by the current sequrin.com build.</p><p class="updated">Last updated 22 August 2026</p></div></section>
<section class="section"><div class="container notice-list">
...
function render(page) {
  ...
  content = content.replace('class="container notice-list"', 'class="container notice-list legal-list"');
  content = content.replace(/<p class="notice-index">\d{2}<\/p>/g, "");
