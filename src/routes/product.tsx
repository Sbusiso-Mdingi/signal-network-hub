...
const operatingFlow = [
  ...
  ["02", "Detect", "Surface unusual activity through rules, statistical methods and network analysis."],
  ["03", "Investigate", "Bring signals, relationships, evidence and review history into one structured workspace."],
  ["04", "Decide", "Keep consequential conclusions and claims decisions with accountable human processes."],
];

function ProductShot({ src, alt, caption, eager = false }: { src: string; alt: string; caption: string; eager?: boolean }) {
  return (
      ...
      <main>
        ...
        <section className="border-b border-border bg-surface">
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 md:py-24 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl leading-tight md:text-5xl">Surface the activity worth examining.</h2>
        ...
        <section className="border-b border-border">
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 md:py-24 lg:grid-cols-[1.28fr_0.72fr] lg:items-center">
            ...
            <div className="lg:order-2">
              ...
              <h2 className="mt-4 text-3xl leading-tight md:text-5xl">See relationships individual records can hide.</h2>
              <p className="mt-6 leading-relaxed text-muted-foreground">
        ...
        <section className="border-b border-border bg-surface">
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 md:py-24 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl leading-tight md:text-5xl">Turn a signal into a traceable investigation.</h2>
              <p className="mt-6 leading-relaxed text-muted-foreground">
        ...
        <section className="border-b border-border">
          <div className="mx-auto max-w-6xl px-6 py-20 md:py-24">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 text-3xl leading-tight md:text-5xl">The product boundary is part of the product.</h2>
              <p className="mt-6 leading-relaxed text-muted-foreground">
            ...
            <div className="mt-12 grid gap-px border border-border bg-border md:grid-cols-2">
              {guardrails.map((guardrail) => (
                <article key={guardrail.title} className="bg-background p-7 md:p-8">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{guardrail.body}</p>
                </article>
              ))}
            </div>

            <div className="mt-10 border border-border-strong bg-surface p-7 md:p-9">
              <p className="font-display text-2xl leading-snug md:text-3xl">Detection creates a signal. Investigation establishes context. Humans remain accountable for consequential decisions.</p>
              ...
              <Link to="/governance" className="mt-6 inline-flex text-sm text-primary underline-offset-4 hover:underline">
        ...
        <section className="border-b border-border bg-surface">
          <div className="mx-auto max-w-6xl px-6 py-20 md:py-24">
            ...
            <h2 className="mt-4 max-w-3xl text-3xl leading-tight md:text-5xl">The pieces work together around investigation.</h2>
            ...
            <Link to="/how-it-works" className="mt-8 inline-flex text-sm text-primary underline-offset-4 hover:underline">
        ...
        <section className="border-b border-border">
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 md:grid-cols-[1fr_auto] md:items-end md:py-24">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-3xl leading-tight md:text-5xl">A clearer operating layer for claims-integrity teams.</h2>
            ...
            <div className="flex flex-wrap gap-3 md:justify-end">
              ...
              <Link to="/how-it-works" className="rounded-md border border-border-strong px-6 py-3 text-sm transition-colors hover:bg-secondary">
                How it works
              </Link>
            </div>
          </div>
