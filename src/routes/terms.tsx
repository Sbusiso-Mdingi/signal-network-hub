...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms governing use of the public Sequrin website and its early-stage product information." },
    ],
...
const sections = [
  { title: "Early-stage information", paragraphs: ["The site describes a product under development. Prototype screens and results may use synthetic data. Nothing on the site is medical, claims, forensic, legal or investment advice; a promise of savings or detection accuracy; an offer to provide a regulated service; or evidence of a customer deployment, regulatory approval or certification."] },
  { title: "Lawful use", paragraphs: ["You may view the site and share links for ordinary informational use. Do not interfere with security, access restrictions or availability; reverse engineer protected prototypes; imply endorsement; remove notices; or use protected content to train a competing model without written permission or a lawful exception."] },
